...
<%@ Register Assembly="DevExpress.Web.ASPxPivotGrid.v11.2, Version=11.2.0.0, Culture=neutral, PublicKeyToken=79868b8147b5eae4"
    ...
    <script type="text/javascript">
        function getShowScrollBar(pivot) {            
            ...
            if(pivotScrollCommand.value == "SHOW") {
                if(pivot.GetHorzScrollContentDiv().offsetWidth < pivot.GetMainElement().offsetWidth)
                    return false;
                return true;
            } else 
                return pivot.GetMainElement().offsetWidth >= 800;
        }
